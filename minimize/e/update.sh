...
#	sleep 2
#	#HUOM.UUDELLEENKIRJOITTAMISTA AJATELLEN TÄSSÄ AO. BLOKISSA SAATTAA OLLA JOTAIN IDEAA
#MUUTEN VAIKKA "for f in $(tar -t) do ..." 
#TARIN VOISI TEHDÄ TAVISKJÄNÄ /tmp ALLE
